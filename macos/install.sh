...
echo '####################################################################'
brewInstallation() {
    APP_LIST=("openkey" "rectangle" "shottr" "maccy" "keepingyouawake" "iterm2" "ghostty" "karabiner-elements" "spotify" "anydesk" "teamviewer" "obs" "chatgpt" "slack" "gpg-suite" "notion" "zoom" "figma" "vlc")
